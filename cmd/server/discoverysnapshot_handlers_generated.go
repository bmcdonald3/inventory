...
//   - GET /discoverysnapshotshots (list all discoverysnapshots)
...
func CreateDiscoverySnapshot(w http.ResponseWriter, r *http.Request) {
    ...
    if err := middleware.PublishResourceEvent(r.Context(), "created", "DiscoverySnapshot", discoverySnapshot.GetUID(), discoverySnapshot); err != nil {
...
func UpdateDiscoverySnapshot(w http.ResponseWriter, r *http.Request) {
    ...
    // <<< FIX: Call the function with the 'middleware.' prefix
    if err := middleware.PublishResourceEvent(r.Context(), "updated", "DiscoverySnapshot", discoverySnapshot.GetUID(), discoverySnapshot); err != nil {
        // Log the error but don't fail the request - events are non-critical
...
func PatchDiscoverySnapshot(w http.ResponseWriter, r *http.Request) {
    ...
    // <<< FIX: Call the function with the 'middleware.' prefix
    if err := middleware.PublishResourceEvent(r.Context(), "patched", "DiscoverySnapshot", discoverySnapshot.GetUID(), discoverySnapshot); err != nil {
        // Log the error but don't fail the request - events are non-critical
...
func UpdateDiscoverySnapshotStatus(w http.ResponseWriter, r *http.Request) {
    ...
    // <<< FIX: Call the function with the 'middleware.' prefix
    if err := middleware.PublishResourceEvent(r.Context(), "updated", "DiscoverySnapshot", res.GetUID(), res); err != nil {
...
func PatchDiscoverySnapshotStatus(w http.ResponseWriter, r *http.Request) {
    ...
    // <<< FIX: Call the function with the 'middleware.' prefix
    if err := middleware.PublishResourceEvent(r.Context(), "patched", "DiscoverySnapshot", res.GetUID(), res); err != nil {
...
func DeleteDiscoverySnapshot(w http.ResponseWriter, r *http.Request) {
    ...
    // <<< FIX: Call the function with the 'middleware.' prefix
    if err := middleware.PublishResourceEvent(r.Context(), "deleted", "DiscoverySnapshot", discoverySnapshot.GetUID(), discoverySnapshot); err != nil {
        // Log the error but don't fail the request - events are non-critical
