...
func runServer(cmd *cobra.Command, args []string) error {
	...
	// --- 5. Start Controller ---
	// Create a context that can be canceled for graceful controller shutdown
	...
	go func() {
		...
		if err := controller.Start(controllerCtx); err != nil {
			// Don't use log.Fatalf here, as it would kill the main server
